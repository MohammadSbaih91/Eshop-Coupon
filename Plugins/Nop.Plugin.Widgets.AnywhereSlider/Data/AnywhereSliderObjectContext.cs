...
{
    public partial class AnywhereSliderObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public AnywhereSliderObjectContext(DbContextOptions<AnywhereSliderObjectContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new AccordinglyMap());
            modelBuilder.ApplyConfiguration(new SliderGroupMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(SliderMap));
            this.DropPluginTable(nameof(AccordinglyMap));
            this.DropPluginTable(nameof(SliderGroupMap));
        }
