...
{
    /// <summary>
    /// OrangeMoney payment processor
    /// </summary>
    public class OrangeMoneyPaymentProcessor : BasePlugin, IPaymentMethod, IWidgetPlugin
    {
        #region Fields
        ...
        public OrangeMoneyPaymentProcessor(CurrencySettings currencySettings,
        ...
        protected virtual void InstallLocaleResources()
        {
            ...
            if (enLanguage != null)
            {
                foreach (var filePath in Directory.EnumerateFiles(_fileProvider.MapPath("~/Plugins/Payments.OrangeMoney/Localization/ResourceString"),
        ...
        {
            var file = Path.Combine(_fileProvider.MapPath("~/Plugins/Payments.OrangeMoney/Localization/ResourceString"), "ResourceString_EN.xml");
        ...
        public void PostProcessPayment(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            _genericAttributeService.SaveAttribute<string>(postProcessPaymentRequest.Order, OrangeMoneyHelper.ORDER_POSTFIX_STRING, randomString);
            ...
            try
            {
                ...
                string validateRequestUrl = _orangeMoneyPaymentSettings.APIEndPoint + "PayPrep?";
            ...
            string checkouProceedtUrl = _orangeMoneyPaymentSettings.APIEndPoint + "PayPrep?";

            var paymentRequestUrl = QueryHelpers.AddQueryString(checkouProceedtUrl, queryParameters);
            // http://10.1.11.162:2424/PaymentHub/PayPrep?merchantCode=COM-CC-05&channelCode=303331&serviceType=proceedCheckout&custEmail=qbs@mail.com&custNum=qbs&merchantTrxNo=9999123&payAmount=66&currencyCode=JOD&PSP=2&callBackUrl=http://localhost:15536/PaymentOrangeMoney/PaymentResponse
        ...
        private IDictionary<string, string> CreateQueryParameters(string serviceType, PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            var randomString = _genericAttributeService.GetAttribute<string>(order, OrangeMoneyHelper.ORDER_POSTFIX_STRING);
            ...
            {
                // merchant code
                ["merchantCode"] = _orangeMoneyPaymentSettings.MerchantCode,
                // channel code
                ...
                // order total
                ["payAmount"] = Math.Round(postProcessPaymentRequest.Order.OrderTotal,2).ToString(),
                // order currency
            ...
            if (serviceType == "proceedCheckout")
            {
                ...
                parameters.Add("PSP", _orangeMoneyPaymentSettings.PSP);
                parameters.Add("callBackUrl", _webHelper.GetStoreLocation() + "PaymentOrangeMoney/PaymentResponse?");
            }
        ...
        {
            return $"{_webHelper.GetStoreLocation()}Admin/PaymentOrangeMoney/Configure";
        }
        ...
        {
            //settings
            _settingService.SaveSetting(new OrangeMoneyPaymentSettings
            {
                MerchantCode = "165",
                ChannelCode = "ESHOP_CHNL_QA",
        ...
        {
            //settings
            _settingService.DeleteSetting<OrangeMoneyPaymentSettings>();
        ...
        {
            return new List<string> { }; // TODO : Remove Because Redirect to original payment method
        }
        ...
        public string PaymentMethodDescription
        {
            ...
            //for example, for a redirection payment method, description may be like this: "You will be redirected to OrangeMoney site to complete the payment"

            get { return null; } //_localizationService.GetResource("Plugins.Payments.OrangeMoney.PaymentMethodDescription")
        }
