...
{
    [ViewComponent(Name = "OrangeOrderPaymentStatus")]
    public class OrderPaymentStatusViewComponent : NopViewComponent
    {
        ...
        public IViewComponentResult Invoke(string widgetZone, object additionalData)
        {
            ...
            if (order.PaymentMethodSystemName != "Payments.OrangeMoney")
                return Content("");
            ...
            else
            {
                ...
                if (!string.IsNullOrWhiteSpace(order.AuthorizationTransactionCode))
                    model.FailStatusMessage = string.Format(_localizationService.GetResource("Plugins.Payments.OrangeMoney.Payment.Fail.StatusCode"), order.AuthorizationTransactionCode);
            }
