...
using Nop.Plugin.Payments.Eskadenia.Factory;
...
namespace Nop.Plugin.Payments.Eskadenia.Controllers
{
    public class PaymentEskadeniaController : BasePaymentController
    {
        #region Fields
        ...
        public PaymentEskadeniaController(IEncryptionService encryptionService,
        ...
        public IActionResult Configure()
        {
            ...
            var eskadeniaPaymentSettings = _settingService.LoadSetting<EskadeniaPaymentSettings>(storeScope);

            var model = new ConfigurationModel
            {
                MerchantCode = eskadeniaPaymentSettings.MerchantCode,
                ChannelCode = eskadeniaPaymentSettings.ChannelCode,
                PSP = eskadeniaPaymentSettings.PSP,
                ActiveStoreScopeConfiguration = storeScope,
                APIEndPoint = eskadeniaPaymentSettings.APIEndPoint,
                CallBackURL = _webHelper.GetStoreLocation() + "PaymentEskadenia/PaymentResponse"
            };

            if (storeScope > 0)
            {
                model.MerchantCode_OverrideForStore = _settingService.SettingExists(eskadeniaPaymentSettings, x => x.MerchantCode, storeScope);
                model.ChannelCode_OverrideForStore = _settingService.SettingExists(eskadeniaPaymentSettings, x => x.ChannelCode, storeScope);
                model.PSP_OverrideForStore = _settingService.SettingExists(eskadeniaPaymentSettings, x => x.PSP, storeScope);
            }

            return View("~/Plugins/Payments.Eskadenia/Views/Configure.cshtml", model);
        }
        ...
        public IActionResult Configure(ConfigurationModel model)
        {
            ...
            //save settings
            EskadeniaPaymentSettings.MerchantCode = model.MerchantCode;
            EskadeniaPaymentSettings.ChannelCode = model.ChannelCode;
            EskadeniaPaymentSettings.PSP = model.PSP;

            /* We do not clear cache after each setting update.
             * This behavior can increase performance because cached settings will not be cleared 
             * and loaded from database after each update */
            _settingService.SaveSettingOverridablePerStore(EskadeniaPaymentSettings, x => x.MerchantCode, model.MerchantCode_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(EskadeniaPaymentSettings, x => x.ChannelCode, model.ChannelCode_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(EskadeniaPaymentSettings, x => x.PSP, model.PSP_OverrideForStore, storeScope, false);
        ...
        {
            // success response - http://localhost:15536/PaymentEskadenia/PaymentResponse/?merchantTrxNo=9999123&patTrxStatus=OPC-00000&payTrxNo=OES-20190929114619173&payAmount=66.0&payTrxDate=29-09-2019&secureHash=$2a$10$qasKb28TEfmc1mQyPK2JhuYojdfyyYK78R5K8egyESDQCJvBgVBPa
            // fail response with wrong card - http://localhost:15536/PaymentEskadenia/PaymentResponse?merchantTrxNo=9999124&patTrxStatus=OPC-00116&payTrxNo=OES-20190929115909174&payAmount=66.0&payTrxDate=&secureHash=
            ...
            switch (patTrxStatus)
            {
                case Nop.Plugin.Payments.Eskadenia.StatusCode.OPC00000:
                    #region Sucesss
                    try
                    {
                        // now need to call PayChyeck API for check payment status
                        string endPointURL = _eskadeniaPaymentSettings.APIEndPoint;
                        ...
                        {
                            string json = "{\"merchantCode\":\"" + _eskadeniaPaymentSettings.MerchantCode + "\"," +
                        ...
                        using (var streamReader = new StreamReader(httpResponse.GetResponseStream()))
                        {
                            ...
                            order.AuthorizationTransactionId = response.payTrxNo;
                            ...
                            if (response.payTrxStatus == Nop.Plugin.Payments.Eskadenia.StatusCode.OPC00000)
                            {
                                // payment success
                    ...
                    break;
                case Nop.Plugin.Payments.Eskadenia.StatusCode.OPC00130:
                    ...
                    #endregion
                    break;
                case Nop.Plugin.Payments.Eskadenia.StatusCode.OPC00131:
                    ...
                    #endregion
                    break;
                case Nop.Plugin.Payments.Eskadenia.StatusCode.OPC00132:
        ...
        public IActionResult PaymentMethod(int orderId)
        {
            ...
            return View("~/Plugins/Payments.Eskadenia/Views/PaymentEskadenia/PaymentMethod.cshtml", model);
        }
        ...
        public virtual IActionResult OpcSavePaymentMethod(string paymentmethod, CheckoutPaymentMethodModel model)
        {
            try
            {
                ...
                //        {
                //            name = "confirm-order",
                //            html = RenderPartialViewToString("~/Plugins/Payments.Eskadenia/Views/PaymentEskadenia/OpcConfirmOrder.cshtml", confirmOrderModel)
                //        },
        ...
        protected virtual JsonResult OpcLoadStepAfterPaymentMethod(IPaymentMethod paymentMethod, List<ShoppingCartItem> cart)
        {
            ...
            return Json(new
            {
                ...
                {
                    name = "payment-info",
                    html = RenderPartialViewToString("~/Plugins/Payments.Eskadenia/Views/PaymentEskadenia/OpcPaymentInfo.cshtml", paymenInfoModel)
                },
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (paymentMethod.PaymentMethodType == PaymentMethodType.Redirection)
                    {
                        ...
                        return Json(new
                        {
                            redirect = $"{_webHelper.GetStoreLocation()}PaymentEskadenia/OpcCompleteRedirectionPayment"
                        });
                    }
