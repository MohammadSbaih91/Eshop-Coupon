...
using System.Linq;
namespace Nop.Plugin.Payments.Eskadenia.ViewEngines
{
    public class PaymentsEskadeniaLocationExpander : IViewLocationExpander
    {
        ...
        public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
        {
            ...
            if (context.Values.TryGetValue(THEME_KEY, out string theme))
            {
                ...
                {
                    viewLocations = new[] {
                        $"~/Plugins/Payments.Eskadenia/Themes/{theme}/Views/Shared/{{0}}.cshtml",
                        $"~/Plugins/Payments.Eskadenia/Views/Shared/{{0}}.cshtml",
                    }
