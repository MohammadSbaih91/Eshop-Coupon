...
namespace Nop.Web.Areas.Admin.Models.EmployeeOrder
{
    public class EmployeeOrderSearchModel : BaseSearchModel
    {
        #region Ctor

        public EmployeeOrderSearchModel()
        {
        ...
        [NopResourceDisplayName("Admin.Orders.List.EmployeeName")]
