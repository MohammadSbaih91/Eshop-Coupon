    ...
    public static class MappingExtensions
    {
        ...
        public static Address ToEntity(this AddressModel model, Address destination, bool trimFields = true)
        {
            ...
            if (trimFields)
            {
                ...
                if (model.IdentityCardOrPassport != null)
                    model.IdentityCardOrPassport = model.IdentityCardOrPassport.Trim();
            }
            ...
            destination.Nationality = model.Nationality;
            destination.NationalityType= model.NationalityType;
            destination.Civility = model.Civility;
            destination.IdentityCardOrPassport = model.IdentityCardOrPassport ;
