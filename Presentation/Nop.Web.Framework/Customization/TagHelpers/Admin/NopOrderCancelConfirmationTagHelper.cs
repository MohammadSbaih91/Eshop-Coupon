...
namespace Nop.Web.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("nop-ordercancel-confirmation", Attributes = ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class NopOrderCancelConfirmationTagHelper : TagHelper
    {
        ...
        public NopOrderCancelConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.Content.SetHtmlContent(await _htmlHelper.PartialAsync("OrderCancelConfirm", actionConfirmationModel));
